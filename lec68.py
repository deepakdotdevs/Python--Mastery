# Key Point -> Magic/Dunder Methods in Python : 

# Magic/Dunder Methods in
# Python
...
# Let's take a look at some of the most commonly used magic
# methods in Python.
...
# The call method is used to make an
# object callable, meaning that you
# can pass it as a parameter to a
# function and it will be executed
# when the function is called. This is
# an incredibly powerful tool that
# allows you to create objects that
# behave like functions.

# These are just a few of the many
# magic methods available in Python.
# They are incredibly powerful tools
# that allow you to customize the
# behaviour of your objects, and can
# make your code much cleaner and
# easier to understand. So if you're
# looking for a way to take your
# Python code to the next level, take
# some time to learn about these
# magic metnods.
# ----------------------------------------------------------------
...
# e = Employee()
# print(e.name)
# print(len(e)) # i want this so we need to define this method
...
class Employee:
    ...
    def __len__(self):
        ...
        for c in self.name:
            i = i+1
        return i 
    # for representation in another class take is 70.py for now
    def __str__(self):
