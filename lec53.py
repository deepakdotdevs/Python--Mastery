# Key Points : Introduction to OOPS in Python 
...
# created that inherit the properties and methods of an existing class. This allows for code
# reuse and makes it easy to create new classes that have similar functionality to existing
# classes.

# Polymorphism is also supported in Python, which means that objects of different classes
# can be treated as if they were objects of a common class. This allows for greater flexibility
# in code and makes it easier to write code that can work with multiple types of objects.
...
# there i maintained 3-3 variables every time
# Classes and objects helps to maintained it
...
# deepak ---> deepak ki info wala form --> Object Entity
# Kashish ---> Kashish ki info wala form --> Object Entity
# Shubham ---> Shubham ki info wala form --> Shubham Entity

kashish.changeName("Aupuoo")
# ------------------------------------------------------------------------------
