...
# working on projects that have conflicting package versions or packagas that are not compatible with each other.
...
# Activate the virtual environment (Linux/maxOS)
...
# to install the packages listed in the requirements.txt file, you can use the pip install command with -r flag:
