# Key Point : Exercise No. 6 - Library Management System in Python 
...
# and show how you can print all books, add a book and get the number of
# books using different methods. Show that your program doesnt persist
